...
import com.itachi1706.cepaslib.card.iso7816.ISO7816Application;
import com.itachi1706.cepaslib.card.iso7816.ISO7816SelectorElement;
import com.itachi1706.cepaslib.xml.Base64String;
import com.itachi1706.cepaslib.xml.CardConverter;
import com.itachi1706.cepaslib.xml.CardTypeTransform;
import com.itachi1706.cepaslib.xml.EpochCalendarTransform;
import com.itachi1706.cepaslib.xml.HexString;
import com.itachi1706.cepaslib.xml.ISO7816Converter;
import com.itachi1706.cepaslib.xml.SkippableRegistryStrategy;
...
public class CEPASReaderApplication extends MultiDexApplication {
    ...
    private static CEPASReaderApplication sInstance;

    private final Serializer mSerializer;
    private boolean mMifareClassicSupport = false;

    public CEPASReaderApplication() {
        sInstance = this;
    ...
    public static CEPASReaderApplication getInstance() {
        return sInstance;
    }

    public static boolean convertTimezones() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(getInstance());
        return prefs.getBoolean(CEPASReaderApplication.PREF_CONVERT_TIMEZONES, false);
    }
    ...
    public static boolean showRawStationIds() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(CEPASReaderApplication.getInstance());
        return prefs.getBoolean(CEPASReaderApplication.PREF_SHOW_RAW_IDS, false);
    }
}
