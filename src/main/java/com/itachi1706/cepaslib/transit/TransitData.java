...
public abstract class TransitData implements Parcelable {
     ...
     *
     * @return Array of List<? extends Trip>, or null if not supported.
     */
     ...
     * <ul>
     * <li>Check for {@link CEPASReaderApplication#hideCardNumbers()} whenever you show a card
     ...
     * {@link com.itachi1706.cheesecakeutilities.Modules.CEPASReader.util.TripObfuscator#maybeObfuscateTS}.  This also
