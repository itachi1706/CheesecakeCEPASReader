 ...
 */
package com.itachi1706.cepaslib.card.cepascompat;
...
public class CEPASCompatTransaction implements Parcelable {
    ...
    /**
     * This is the date expressed as seconds since the UNIX epoch. SGCardReader <= 2.9.34 used
     ...
     * SGCardReader >= 2.9.35 uses this value, old versions use {@link #mDate} instead.
     */
    ...
    public Calendar getTimestamp() {
        if (mDate != 0) {
            // Compatibility for SGCardReader <= 2.9.34
