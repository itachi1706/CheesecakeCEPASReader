...
import com.itachi1706.cepaslib.card.TagReaderFeedbackInterface;
import com.itachi1706.cepaslib.card.UnsupportedTagException;
import com.itachi1706.cepaslib.transit.CardInfo;
...
public class ReadingTagActivity extends AppCompatActivity implements TagReaderFeedbackInterface {
    ...
    public void showCardType(final CardInfo cardInfo) {
        runOnUiThread(() -> {
            ...
            if (cardInfo != null) {
                ...
                i.setImageResource(R.drawable.ezlink_card);
    ...
    private void resolveIntent(Intent intent) {
        try {
            ...
            String lastReadId = prefs.getString(CEPASReaderApplication.PREF_LAST_READ_ID, "");
            long lastReadAt = prefs.getLong(CEPASReaderApplication.PREF_LAST_READ_AT, 0);
    ...
    class ReadingTagTask extends AsyncTask<ReadingTagTaskEventArgs, String, String> {

        private Exception mException;
        private boolean mPartialRead;

        @Override
        protected String doInBackground(ReadingTagTaskEventArgs... params) {
            ...
            try {
                ...
                String cardXml = card.toXml(CEPASReaderApplication.getInstance().getSerializer());
                ...
                prefs.putString(CEPASReaderApplication.PREF_LAST_READ_ID, tagIdString);
                prefs.putLong(CEPASReaderApplication.PREF_LAST_READ_AT, GregorianCalendar.getInstance().getTimeInMillis());
                prefs.apply();
        ...
        @Override
        protected void onPostExecute(String cardUri) {
            if (mPartialRead) {
