...
import com.itachi1706.cepaslib.fragment.CardBalanceFragment;
import com.itachi1706.cepaslib.fragment.CardInfoFragment;
import com.itachi1706.cepaslib.fragment.CardTripsFragment;
import com.itachi1706.cepaslib.fragment.UnauthorizedCardFragment;
import com.itachi1706.cepaslib.transit.TransitData;
import com.itachi1706.cepaslib.transit.unknown.UnauthorizedTransitData;
import com.itachi1706.cepaslib.ui.TabPagerAdapter;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    mCard = Card.fromXml(CEPASReaderApplication.getInstance().getSerializer(), xml);
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                try {
                    ...
                    args.putString(EXTRA_CARD,
                            mCard.toXml(CEPASReaderApplication.getInstance().getSerializer()));
