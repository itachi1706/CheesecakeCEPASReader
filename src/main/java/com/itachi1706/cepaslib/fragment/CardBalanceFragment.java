...
import com.itachi1706.cepaslib.activity.CardInfoActivity;
import com.itachi1706.cepaslib.card.Card;
import com.itachi1706.cepaslib.transit.TransitBalance;
    ...
    private class BalancesAdapter extends ArrayAdapter<Object> {
        ...
        private View getBalanceView(View convertView,
            ...
            if (balance.getValidFrom() != null && balance.getValidTo() != null) {
                ...
                Serializer serializer = CEPASReaderApplication.getInstance().getSerializer();
